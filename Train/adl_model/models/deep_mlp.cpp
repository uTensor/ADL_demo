...
{    
    ctx.add(new BinaryTensor<float>({5}, inline_Variable_5_0), 
            "Variable_5:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({480,64}, inline_Variable_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<uint8_t>({64,64}, inline_Variable_2_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({64,5}, inline_Variable_4_0), 
            "Variable_4:0", 
            2);
}
{    
